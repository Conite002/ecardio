              ...
              children: List<Widget>.generate(
                ...
                (int index) {
                  ...
                  return CategoryView(
                    callback: () {
                      moveTo(
                        Category.popularCourseList[index].title,
                        Category.popularCourseList[index].description,
                        Category.popularCourseList[index].money,
                        Category.popularCourseList[index].rating,
                        Category.popularCourseList[index].rewards,
                      );
                    },
